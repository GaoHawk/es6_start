...
* @Last Modified time: 2016-10-17 17:17:06
*/
...
<div class="uctopkuang_div">
      ...
      <a href="#userCenter" class="quitbtn_a db fr mui-tab-item" style="font-size: 70%;" >
        <img src="images/userPage/tuichu2.png"  />
      </a>
    ...
    <div class="zjlbtop_div">
     ...
     <div class="rmyxtjtop_div">
          <ul class="rmyxlb_ul" id="recommend_game">
             <li><div class="rmyxicon fl"><a href="#tabbar-game-detail" class="mui-tab-item"><img src="http://img-home.49app.com/./Uploads/2016-05/574d60aedcd8a.png"></a></div><div class="rmyxcon_right fl"><p class="rmyxtj_p1">幻灵仙域</p> <p class="rmyxtj_p2">修仙 | 69M</p><a href="game.apk" download="game.apk" class="rmyxtj_a db">
                    <img src="images/lijixiazai.png"  />
             </a></div></li>
             <li style="margin-right:0;"><div class="rmyxicon fl"><a href="#tabbar-game-detail" class="mui-tab-item"><img src="images/baye.jpg"></a></div><div class="rmyxcon_right fl"><p class="rmyxtj_p1">霸业</p> <p class="rmyxtj_p2">SLG | 82M</p><a href="game.apk" download="game.apk" class="rmyxtj_a db"><img src="images/lijixiazai.png"  /></a></div></li>
             <li><div class="rmyxicon fl"><a href="#tabbar-game-detail" class="mui-tab-item"><img src="images/userPage/jxqy1.png"></a></div><div class="rmyxcon_right fl"><p class="rmyxtj_p1">剑侠情缘</p> <p class="rmyxtj_p2">游戏助手 | M</p><a href="http://down.49app.com/download/heziyy/android/0.0/49you_b_appbox_007.apk" download="game.apk" class="rmyxtj_a db"><img src="images/lijixiazai.png"  /></a></div></li>
             <li style="margin-right:0;"><div class="rmyxicon fl"><a href="#tabbar-game-detail" class="mui-tab-item"><img src="images/fbys.png"></a></div><div class="rmyxcon_right fl"><p class="rmyxtj_p1">风暴要塞</p> <p class="rmyxtj_p2">策略类 | 99M</p><a href="game.apk" download="game.apk" class="rmyxtj_a db"><img src="images/lijixiazai.png"  /></a></div></li>
